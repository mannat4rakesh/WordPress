...
package org.mule.modules.wordpress.generated.processors;
...
/**
 * GetPostsMessageProcessor invokes the {@link org.mule.modules.wordpress.WordPressConnector#getPosts(java.lang.String)} method in {@link WordPressConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedField = ((String) evaluateAndTransform(getMuleContext(), event, GetPostsMessageProcessor.class.getDeclaredField("_fieldType").getGenericType(), null, field));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((WordPressConnector) object).getPosts(_transformedField);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at WordPressConnector at getPosts retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
