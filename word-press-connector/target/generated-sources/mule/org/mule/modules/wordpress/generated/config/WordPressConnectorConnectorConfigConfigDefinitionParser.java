...
import org.mule.modules.wordpress.generated.adapters.WordPressConnectorConnectorConfigBasicAdapter;
...
public class WordPressConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(WordPressConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, WordPressConnectorConnectorConfigBasicAdapter.class);
        setDestroyMethodIfNeeded(builder, WordPressConnectorConnectorConfigBasicAdapter.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(WordPressConnectorConnectorConfigBasicAdapter.class.getName());
