...
/**
 * A <code>WordPressConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link WordPressConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-13T10:46:07-08:00", comments = "Build UNNAMED.2793.f49b6c7")
public class WordPressConnectorLifecycleInjectionAdapter
    extends WordPressConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(WordPressConnectorLifecycleInjectionAdapter.class);
