...
import org.mule.modules.wikicon.generated.adapters.WikiconConnectorConnectorConfigBasicAdapter;
...
public class WikiconConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(WikiconConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, WikiconConnectorConnectorConfigBasicAdapter.class);
        setDestroyMethodIfNeeded(builder, WikiconConnectorConnectorConfigBasicAdapter.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(WikiconConnectorConnectorConfigBasicAdapter.class.getName());
