...
/**
 * A <code>WikiconConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link WikiconConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-11-09T10:05:59-08:00", comments = "Build UNNAMED.2793.f49b6c7")
public class WikiconConnectorLifecycleInjectionAdapter
    extends WikiconConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(WikiconConnectorLifecycleInjectionAdapter.class);
